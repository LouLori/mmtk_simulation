...
##################################################
for i in range(nmolecules):
        ff.append(HarmonicOscillatorForceField(universe.objectList()[i].atomList()[2], center[i], float(1.0e7)))
...
for step in trajectory:
        ...
        for a in range(len(universe.objectList()) - 1):         # loops over all molecules
                        ...
                        cost2=dot(asarray(rcom2),ez)/(sqrt( rcom2[0]*rcom2[0] + rcom2[1]*rcom2[1] + rcom2[2]*rcom2[2] ) )
