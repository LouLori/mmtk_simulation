...
class ElectrostaticForceField(ForceField):
    ...
    def __init__(self, universe,fraction,o_charge,nwaters):
        ...
        waters = []
        for o in range(nwaters):
           waters.append(universe.objectList()[o])
...
class LennardJonesForceField(ForceField):
    ...
    def __init__(self, universe, epsilon, sigma,nwaters):
